...
namespace LocalAIAgent.API.Infrastructure.Migrations
{
    ...
    [Migration("20260903115857_StoreDatasetCollectionInLlmSettings")]
    partial class StoreDatasetCollectionInLlmSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalAIAgent.API.Infrastructure.Models.AiSettings", b =>
                {
                    ...
                    b.Property<bool>("UseResultsForDataset")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LocalAIAgent.API.Infrastructure.Models.UserPreferences", b =>
                {
                    ...
                    b.Property<int?>("SelectedAiSettingsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SelectedAiSettingsId");
            ...
            modelBuilder.Entity("LocalAIAgent.API.Infrastructure.Models.UserPreferences", b =>
                {
                    b.HasOne("LocalAIAgent.API.Infrastructure.Models.AiSettings", "SelectedAiSettings")
                        .WithMany()
                        .HasForeignKey("SelectedAiSettingsId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SelectedAiSettings");
